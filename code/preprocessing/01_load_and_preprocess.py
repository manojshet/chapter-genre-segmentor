...
if __name__ == '__main__':
    ...
    df_segregated_genre = splitGenres(df)

    log_file2 = config.get('01_load_and_preprocess', 'segregated_genre_processed_data_loc')
    df_segregated_genre.to_csv(log_file2, index=False)
    print('Saved genre segregated result to log file!')
